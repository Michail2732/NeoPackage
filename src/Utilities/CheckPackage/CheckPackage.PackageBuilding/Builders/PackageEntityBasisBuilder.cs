...
{
    public sealed class PackageEntityBasisBuilder : IPackageEntityBasisBuilder
    {       
        ...
        private IEnumerable<EntityBuildingResult> BuildPrivate(PackageContext context, CancellationToken ct)
        {
            ...
            string packageDir = context.Configuration["package_dir"];
            bool includeHash = bool.Parse(context.Configuration["is_check_hash"]);
